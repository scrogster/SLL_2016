...
author: 
 - Michael P. Scroggie^[Arthur Rylah Institute for Environmental Research, Department of Environment, Land, Water and Planning, 123 Brown St, Heidelberg, Victoria 3084, Australia, and School of Biosciences, University of Melbourne, Victoria 3010, Australia. Corresponding author. michael.scroggie@delwp.vic.gov.au] 
...
All R and JAGS code and data necessary to reproduce the analyses presented in this paper are available at https://github.com/scrogster/SLL_2016. Upon acceptance for publication, a snapshot of the code and data will be archived in the Zenodo research repository.  

# Author Contributions

GNL and DHR initiated the study. GNLP, DHR and MPS designed the sampling program. GNLP, DHR and EN collected the data. MPS and GWH analysed the data. MPS lead the writing of the manuscript with contributions from all authors. 

# Biosketch

Michael Scroggie, Garry Peterson and Evelyn Nicholson are all employees of the State of Victoria's Department of Environment, Land, Water and Planning. They share a strong interest in the ecology and conservation of threatened herpetofauna. Detlef (Ted) Rohr is director of Research Ethics and Compliance at the University of New South Wales who maintains a keen interest in conservation biology. Geoff Heard is a herpetologist and lecturer in the School of Environmental Sciences at Charles Sturt University.  
