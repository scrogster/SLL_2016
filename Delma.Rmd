...
Running title: \textsc{Fragmentation, disturbance and reptile occupancy}
...
**Aim:       ** In fragmented landscapes, conservation practitioners face complex decisions as they seek to maximize the viability of populations. Effective decision-making is often hampered by a lack of knowledge regarding the relative contributions of patch sizes, habitat characteristics, disturbance regimes and the spatial arrangement of habitat on the occupancy dynamics and viability of populations. We sought to determine the drivers of occupancy, persistence and colonisation for populations of the threatened Striped Legless Lizard (*Delma impar*) inhabiting native grassland fragments.

**Location:     ** A fragmented grassland landscape in Victoria, Australia.

**Methods:    **  We monitored patch occupancy of *D. impar* at 291 remnant grassland sites for nine years. The data were analysed using a dynamic occupancy model which allowed for imperfect detection. We used the model to assess the effects of patch characteristics, disturbance regimes and spatial arrangement of habitat on the occupancy dynamics of the species.
...
Michael Scroggie, Garry Peterson and Evelyn Nicholson are all employees of the State of Victoria's Department of Environment, Land, Water and Planning. They share a strong interest in the ecology and conservation of threatened herpetofauna. Detlef (Ted) Rohr is Director of Research Ethics and Compliance and member of the UNSW Evolution and Ecology Research Group at the University of New South Wales who maintains a keen interest in reptile conservation. Geoff Heard is a herpetologist and lecturer in the School of Environmental Sciences at Charles Sturt University.  

GNLP and DHR initiated the study. GNLP, DHR and MPS designed the sampling program. GNLP, DHR and EN collected the data. MPS and GWH analysed the data. MPS lead the writing of the manuscript with contributions from all authors.
