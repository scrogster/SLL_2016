...
author: 
 - Michael P. Scroggie^[Arthur Rylah Institute for Environmental Research, 123 Brown St, Heidelberg, Victoria, Australia 3084. michael.scroggie@delwp.vic.gov.au] 
 - Garry N. L. Peterson^[Deparment of Environment, Land, Water and Planning, 703-709 Raglan Parade, Warrnambool, Victoria, Australia 3280.] 
 - Detlef H. Rohr^[Ecology and Evolution Research Centre, University of New South Wales, Sydney, New South Wales, Australia 2052.]  
 - Evelyn Nicholson^[Deparment of Environment, Land, Water and Planning, 12 Murray St, Heywood, Victoria, Australia, 3304]
 - Geoffrey W. Heard^[School of Bioscience, University of Melbourne, Victoria, Australia 3052.]
header-includes:
...
survey.per.site<-surveys.per.year/sites.per.year

survey_table<-data.frame("Year"=paste0(2004:2012, "/", 2005:2013), "Sites"=sites.per.year, "Surveys"=surveys.per.year, "Surveyspersite"=survey.per.site)

kable(survey_table, digits=2, align=c("c", "c", "c","c"), col.names=c("Year", "Sites surveyed","Total surveys","Surveys per site"),
			caption="Summary of survey effort during the 9 years of monitoring", booktabs=TRUE)
