...
```{r, fig.cap="Map of Victoria, Australia showing locations of sites where *D. impar* was, and was not detected during the study.", fig.pos="H", echo=FALSE, cache=FALSE, out.width = "6in", fig.align='center'}
...
```{r, fig.cap="Posterior densities of regression parameters relating the covariates of the dynamic occupancy model to (A) initial occupancy, (B) annual probability of persistence, and (C) annual probability of colonisation by *Delma impar* in remnant grassland sites in Western Victoria.", fig.pos="H", echo=FALSE, cache=FALSE, out.width = "4in", fig.align='center'}
knitr::include_graphics("Figures/parameter_plot.pdf")
```

```{r, fig.cap="Predicted effects of covariates on A. initial occupancy, B. persistence and C. colonisation by *D. impar* in grassland remnants in Western Victoria.", fig.pos="H", echo=FALSE, cache=FALSE, out.width = "4in", fig.align='center'}
