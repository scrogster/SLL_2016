...
$$\log \dfrac{\psi_{i,1}}{1-\psi_{i,1}}=\beta_{0}+\beta_{1}grass_{i}+\beta_{2}conserv_{i}+\beta_{3}graze_{i} $$
...
$$
\begin{aligned}
\log \dfrac{\phi_{i,t}}{1-\phi_{i,t}}=\lambda_{0}+\lambda_{1}grass_{i}+\lambda_{2}fire_{i}+\lambda_{3}graze_{i}+\lambda_{4}conserv_{i}
\end{aligned}
$$
...
$$\log \dfrac{\gamma_{i,t}}{1-\gamma_{i,t}}=\delta_{0}+\delta_{1}grass_{i} $$              
...
$$
\begin{aligned}
\log \dfrac{p^{liz}_{j}}{1-p^{liz}_{j}} &=\alpha_{1}+ \\
...
$$
\begin{aligned}
\log \dfrac{p^{skin}_{j}}{1-p^{skin}_{j}} &=\alpha_{10}+ \\
...
Prior to analysis, Julian dates were tranformed to the interval $[1,0]$, times of day (measured in hours) were centered around midday, and temperatures were centered around the approximate mean value of $22^{\circ}C$.
