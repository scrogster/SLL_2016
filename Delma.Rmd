...
```{r, fig.cap="Map of Victoria, Australia showing locations of sites where *D. impar* was, and was not detected during the study.", fig.pos="H", echo=FALSE, cache=FALSE}
