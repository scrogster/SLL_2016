...
Probabilities of initial site occupancy $(\phi_{1})$ by *D. impar* were positively associated with the extent of native grassland in the surrounding 1000 m radius, the proportion of clay minerals in the soil, and on roadside habitat, consistent with our initial hypotheses about the effects of these habitat variables on initial occupancy. 

Over the course of the study, the proportion of our sites occupied by *D. impar* has declined.  The rate of local extinctions outstripped the rate at which unoccupied sites were colonised. If the observed rates of decline at the study sites are consistent with broader trends in occupancy of remnant habitat across the species' range, then a continuing decline in the conservation status of *D. impar* is to be expected. Declines were most marked during the first year of the study, a period coinciding with a prolonged and severe drought in south-eastern Australia [@dijk2013millennium].
