...
kable(survey_table, digits=2, align=c("l", "c", "c","c", "c", "c", "c",  "c", "c"), 
			...
			caption="Table 1. Summary of annual survey effort and detections of *D. impar* during the 9 years of monitoring, with predicted occupancy for each year over this period.", booktabs=TRUE)
```
